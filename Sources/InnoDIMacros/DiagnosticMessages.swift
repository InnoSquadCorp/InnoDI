...
extension SimpleDiagnostic {
    ...
    static func generateMockUnsupportedMember(memberNames: [String]) -> Self {
        ...
        return Self(
            "@GenerateMock cannot synthesize this protocol because one or more requirements or protocol features are unsupported: \(listed)\(suffix). Associated types, protocol inheritance other than AnyObject, static/class requirements, subscripts, rethrows or typed throws, inout parameters, and opaque return types need a hand-written mock until the RFC 0001 support matrix expands.",
