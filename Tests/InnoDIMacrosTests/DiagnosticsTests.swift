...
struct DiagnosticsTests {
    ...
    func diagnosticFactoriesExposeStableMessageIDValues() {
        let cases: [(diag: SimpleDiagnostic, expectedID: MessageID)] = [
            ...
            (SimpleDiagnostic.provideUnknownEffect("network"), MessageID(domain: "InnoDI.usage", id: "provide.unknown-effect")),
            (SimpleDiagnostic.provideUnknownInitialization("lazy"), MessageID(domain: "InnoDI.usage", id: "provide.unknown-initialization")),
            (SimpleDiagnostic.provideInvalidCollectionMetadata(), MessageID(domain: "InnoDI.usage", id: "provide.invalid-collection-metadata")),
            (SimpleDiagnostic.provideDuplicateCollectionKey(key: "auth"), MessageID(domain: "InnoDI.validation", id: "provide.duplicate-collection-key")),
            (SimpleDiagnostic.provideUnknownCollectionContributor(memberName: "services", contributorName: "missing"), MessageID(domain: "InnoDI.validation", id: "provide.unknown-collection-contributor")),
            (SimpleDiagnostic.provideAsyncCollectionContributor(memberName: "services", contributorName: "remote"), MessageID(domain: "InnoDI.validation", id: "provide.async-collection-contributor")),
            (SimpleDiagnostic.provideInitializationInvalidScope(memberName: "request"), MessageID(domain: "InnoDI.validation", id: "provide.initialization-invalid-scope")),
            (SimpleDiagnostic.provideOnDemandAsyncUnsupported(memberName: "request"), MessageID(domain: "InnoDI.validation", id: "provide.ondemand-async-unsupported")),
            (SimpleDiagnostic.assistedFactoryInvalidDeclaration(), MessageID(domain: "InnoDI.usage", id: "assisted-factory.invalid-declaration")),
            (SimpleDiagnostic.assistedFactoryMissingDeclaration(), MessageID(domain: "InnoDI.validation", id: "assisted-factory.missing-declaration")),
            (SimpleDiagnostic.assistedFactoryInvalidArguments(), MessageID(domain: "InnoDI.usage", id: "assisted-factory.invalid-arguments")),
            (SimpleDiagnostic.assistedFactoryDuplicateInput(), MessageID(domain: "InnoDI.validation", id: "assisted-factory.duplicate-input")),
            (SimpleDiagnostic.assistedFactoryInputPartitionMismatch(expectedStatic: ["session"], expectedAssisted: ["id"]), MessageID(domain: "InnoDI.validation", id: "assisted-factory.input-partition-mismatch")),
            (SimpleDiagnostic.assistedFactoryAccessLevelMismatch(factoryAccess: "public", bridgeAccess: "internal"), MessageID(domain: "InnoDI.validation", id: "assisted-factory.access-level-mismatch")),
            (SimpleDiagnostic.multibindingInvalidContributors(), MessageID(domain: "InnoDI.usage", id: "multibinding.invalid-contributors")),
            (SimpleDiagnostic.multibindingEmptyContributors(), MessageID(domain: "InnoDI.validation", id: "multibinding.empty-contributors")),
            (SimpleDiagnostic.multibindingDuplicateContributor(), MessageID(domain: "InnoDI.validation", id: "multibinding.duplicate-contributor")),
            (SimpleDiagnostic.multibindingCollectionTypeRequired(memberName: "interceptors"), MessageID(domain: "InnoDI.validation", id: "multibinding.collection-type-required")),
            (SimpleDiagnostic.multibindingUnknownContributor(memberName: "interceptors", contributorName: "metrics"), MessageID(domain: "InnoDI.validation", id: "multibinding.unknown-contributor")),
            (SimpleDiagnostic.multibindingAsyncContributor(memberName: "interceptors", contributorName: "auth"), MessageID(domain: "InnoDI.validation", id: "multibinding.async-contributor")),
            (SimpleDiagnostic.multibindingTypeMismatch(memberName: "interceptors", contributorName: "auth", expectedType: "any Interceptor", actualType: "Logger"), MessageID(domain: "InnoDI.validation", id: "multibinding.type-mismatch")),
            ...
            (SimpleDiagnostic.containerRoleTokenRequired(), MessageID(domain: "InnoDI.validation", id: "container.role-token-required")),
            ...
            (SimpleDiagnostic.swiftUIFeatureRootInvalidAlias(alias: "not-valid"), MessageID(domain: "InnoDI.validation", id: "swiftui.feature-root-invalid-alias")),
            (SimpleDiagnostic.swiftUIFeatureRootInvalidRoot(), MessageID(domain: "InnoDI.validation", id: "swiftui.feature-root-invalid-root")),
            (SimpleDiagnostic.swiftUIEnvironmentBridgeUnknownMember(memberName: "missing"), MessageID(domain: "InnoDI.validation", id: "swiftui.environment-bridge-unknown-member")),
            (SimpleDiagnostic.swiftUIEnvironmentBridgeDuplicateMember(memberName: "service"), MessageID(domain: "InnoDI.validation", id: "swiftui.environment-bridge-duplicate-member")),
            ...
            (SimpleDiagnostic.swiftUIEnvironmentBridgeInvalidKeyPath(label: "member"), MessageID(domain: "InnoDI.validation", id: "swiftui.environment-bridge-invalid-keypath")),
            (SimpleDiagnostic.swiftUIEnvironmentBridgeInvalidKeyPath(label: "environment"), MessageID(domain: "InnoDI.validation", id: "swiftui.environment-bridge-invalid-keypath")),
            ...
            (SimpleDiagnostic.swiftUIEnvironmentBridgeInvalidArguments(), MessageID(domain: "InnoDI.validation", id: "swiftui.environment-bridge-invalid-arguments")),
            ...
            (SimpleDiagnostic.internalCodegenInvariant(description: "unexpected state"), MessageID(domain: "InnoDI.validation", id: "internal.codegen-invariant")),
            (SimpleDiagnostic.previewWithContainerMissingContainerExpression(), MessageID(domain: "InnoDI.validation", id: "swiftui.preview-with-container-missing-container")),
            (SimpleDiagnostic.previewWithContainerMissingTrailingClosure(), MessageID(domain: "InnoDI.validation", id: "swiftui.preview-with-container-missing-closure")),
            (SimpleDiagnostic.previewWithContainerMissingContainerParameter(), MessageID(domain: "InnoDI.validation", id: "swiftui.preview-with-container-missing-parameter"))
        ]
