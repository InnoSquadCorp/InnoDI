...
struct DiagnosticsTests {
    ...
    func diagnosticFactoriesExposeStableMessageIDValues() {
        let cases: [(diag: SimpleDiagnostic, expectedID: MessageID)] = [
            ...
            (SimpleDiagnostic.provideBoolLiteralRequired(label: "concrete"), MessageID(domain: "InnoDI.validation", id: "provide.bool-literal-required")),
            (SimpleDiagnostic.provideInvalidWithDependencies(memberName: "service"), MessageID(domain: "InnoDI.validation", id: "provide.invalid-with-dependencies")),
