...
struct AppContainer {
    ...
    init(config: AppConfig, apiClient: APIClient, logger: Logger? = nil, feature: FeatureContainer? = nil, featureOverrides: ((inout FeatureContainer.Overrides) -> Void)? = nil) {
    ...
    init(config: AppConfig, apiClient: APIClient, _ applyOverrides: (inout Overrides) -> Void) {
        ...
        self.init(config: config, apiClient: apiClient, logger: overrides.logger, feature: overrides.feature, featureOverrides: overrides.featureOverrides)
    }
