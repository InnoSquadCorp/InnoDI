...
struct AppContainer {
    ...
    // MARK: - Initialization
    init(config: AppConfig, logger: Logger? = nil, feature: FeatureContainer? = nil, featureOverrides: ((inout FeatureContainer._InnoDIMountOverrides) -> Void)? = nil, _innoDITrace: DITraceContext = .disabled) {
